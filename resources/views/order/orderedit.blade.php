              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control category" name="name" placeholder="Enter customer name"value="{{$order->customername}}">
                  </div>
                  <div class="col-sm-10">
                    <label for="" class="">Customer Address</label>
                    <input type="text" class="form-control category" name="address" placeholder="Enter customer address"value="{{$order->customeraddress}}">
                  </div>
                  <div class="col-sm-10">
                    <label for="" class="">Customer phone number</label>
                    <input type="number" class="form-control category" name="number" placeholder="Enter customer phone number"value="{{$order->customernumber}}">
                  </div>
                </div>
                <div class="form-group">
                	<div class="col-sm-10">
                  ...
                  <select class="form-control status" name="product_id" id='selc'>
                    ...
                    <option data-ids="{{$pro->price}}"class="" data-quantity='{{$pro->quantity}}' value="{{$product->id}}" {{$order->product_id == $pro->id ? 'selected': ''}}>{{$pro->product}}</option>
                    @endforeach
                ...
                <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control category" name="quantity" placeholder=""id="quantity"value="{{$order->quantity}}">
                  </div>
                  </div>
                  <div class='form-group'>
                <div class="col-sm-10">
                    <label for="" class="">Rate</label>
                    <input type="number" class="form-control category" name="rate" placeholder=""id='rate'value="{{$order->rate}}">
                  </div>
                  </div>
                  <div class='form-group'>
                <div class="col-sm-10">
                    <label for="" class="">Total amount</label>
                    <input type="number" class="form-control category" name="totalamount" placeholder=""id="amount" value="{{$order->totalamount}}">
                  </div>
                  </div>
                  <div class='form-group'>
                <div class="col-sm-10">
                ...
                <div class="col-sm-10">
                    ...
                    <input type="number" class="form-control category" name="finalprice" placeholder=""id='net' value="{{$order->finalprice}}">
                  </div>
                  </div>
                  <div class="form-group">
                  <div class="col-sm-10">
